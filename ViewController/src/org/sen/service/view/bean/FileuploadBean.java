package org.sen.service.view.bean;
...
import org.sen.service.view.service.FileScaningService;

public class FileuploadBean {
    public FileuploadBean() {
    }

    public void onFileuploadAttChangeListener(AttributeChangeEvent attributeChangeEvent) {
        // Add event code here...        
        System.out.println("onFileuploadValueChangeListener:: newValue - ");
    }
    ...
    private void uploadFileAndScan(UploadedFile file) {
        ...
        try {
            ...
            boolean validated = FileScaningService.validateAttachmentFile_win(fileName);
            if (validated == false) {                
