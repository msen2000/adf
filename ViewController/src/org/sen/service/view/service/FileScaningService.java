package org.sen.service.view.service;
...
/**
 * Refer : FileUploadBean
         : PTScanService
 * @see 
 */
public class FileScaningService {
...
//            return true;
//        }
        String virusSCANCMD = "C:\\Temp\\scan\\scan.bat";
        System.out.println("CMD:" + virusSCANCMD + ":");
        if (virusSCANCMD == null || StringUtils.isBlank(virusSCANCMD))
            return false;
